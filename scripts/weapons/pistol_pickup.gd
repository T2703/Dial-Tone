...
# Type of the weapon.
@export var weaponType: String = "res://scenes/weapons/pistol.tscn"

# The weapon that should be dropped.
@export var weaponTypeDrop: String = "res://scenes/weapons/pistol_pickup.tscn"
...
func _process(delta: float) -> void:
	...
	if Input.is_action_just_pressed('rclick') and inPickupArea and playerRef: 
		playerRef.equipWeapon(pistol, ammo)
		self.queue_free()
